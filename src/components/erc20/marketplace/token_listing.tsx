...
export const TokensListing = () => {
    ...
    content = (
        <>
            <StyledH1>Add A Token To SwapDex</StyledH1>
            <StyledP>
                SwapDex allows you to trade any ERC20 token, any time, and we charge 0 fees for listing.
            </StyledP>
            <StyledP>
                To add a token to SwapDex, simply past the contract address in the box below and your trading URL's
    ...
    return <StyledListingsCard title="Add A Token To SwapDex">{content}</StyledListingsCard>;
};
