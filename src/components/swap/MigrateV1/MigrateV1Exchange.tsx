...
import { LightCard, PinkCard, YellowCard } from '../Card'
...
export default function MigrateV1Exchange({
  ...
  if (!validatedAddress || tokenAddress === AddressZero) {
    ...
    return <Redirect to="/pool/migrate/v1" />
  }
      ...
      <AutoColumn gap="16px">
        ...
        {!account ? (
          ...
          <>
            ...
            <ButtonConfirmed
              onClick={() => {
                history.push(`/pool/remove/v1/${validatedAddress}`)
              }}
            >
              Remove
            </ButtonConfirmed>
